class Destination {
    ...
    draw(ctx) {
        ...
        ctx.lineTo(this.originX - this.game.camera.x + this.neighbors.prev.x * (100 - 1 * PARAMS.SCALE), this.originY - this.game.camera.y + this.neighbors.prev.y * (100 - 1 * PARAMS.SCALE));
        ctx.stroke();
